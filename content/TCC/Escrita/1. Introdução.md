...
Desenvolver um sistema de reconhecimento facial capaz de identificar alunos do IFMA Campus Caxias por meio de imagens capturadas por câmera, utilizando filtragem inteligente baseada em gênero e faixa etária para reduzir o tempo de busca e aumentar a eficiência da identificação.
### Objetivos Específicos

- Investigar a eficácia do uso de atributos físicos visuais, como gênero e faixa etária, na filtragem de candidatos durante o processo de reconhecimento facial.
- Desenvolver um sistema de identificação de alunos com base em reconhecimento facial, integrando a filtragem inteligente por atributos demográficos utilizando o framework DeepFace.
 - Analisar o desempenho do sistema proposto em termos de acurácia e tempo de resposta, comparando-o com abordagens tradicionais que não utilizam filtragem prévia.
...
Capítulo 3 - Justificativa: Apresenta os motivos que levaram à escolha do tema, destacando sua relevância acadêmica, social e tecnológica. Explica como a aplicação de sistemas de reconhecimento facial com filtragem por atributos físicos pode contribuir para ambientes institucionais, como o IFMA – Campus Caxias, e propõe a importância da pesquisa no contexto atual do reconhecimento facial.

Capítulo 4 – Metodologia: Descreve os métodos e técnicas aplicados no desenvolvimento do sistema proposto, incluindo a preparação dos dados, as etapas de classificação e filtragem, a arquitetura do sistema e os critérios de avaliação.

Capítulo 5 – Resultados e Discussão: Apresenta os testes realizados, os resultados obtidos em termos de tempo de processamento e acurácia, e discute as vantagens e limitações da abordagem proposta.

Capítulo 6 – Considerações Finais: Traz as conclusões do trabalho, as contribuições alcançadas, possíveis aplicações práticas e sugestões para pesquisas futuras.
